...
public class ReLogoPatch extends BasePatch{
	...
	/**
	 * Sprouts (makes) a number of new implicitBees and then executes a set of commands on the
	...
	public AgentSet<beehive.relogo.ImplicitBee> sproutImplicitBees(int number, Closure closure) {
		AgentSet<beehive.relogo.ImplicitBee> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"ImplicitBee");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("beehive.relogo.ImplicitBee")
	public AgentSet<beehive.relogo.ImplicitBee> sproutImplicitBees(int number) {
		return sproutImplicitBees(number,null);
	}
	...
	/**
	 * Sprouts (makes) a number of new passiveActionBees and then executes a set of commands on the
	...
	public AgentSet<beehive.relogo.PassiveActionBee> sproutPassiveActionBees(int number, Closure closure) {
		AgentSet<beehive.relogo.PassiveActionBee> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.sprout(number,closure,"PassiveActionBee");
		for (Turtle t : createResult){
	 ...
	 */
	@ReLogoBuilderGeneratedFor("beehive.relogo.PassiveActionBee")
	public AgentSet<beehive.relogo.PassiveActionBee> sproutPassiveActionBees(int number) {
		return sproutPassiveActionBees(number,null);
	}
